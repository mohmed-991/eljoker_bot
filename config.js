...
module.exports = {
    ...
    URL_1LINK: process.env.URL_1LINK === undefined ? 'http://instagram.com/hetlarr_ofiicial' : process.env.URL_1LINK,
    ...
    FOOTER: process.env.FOOTER === undefined ? '卍 HETLAR 𝙱𝙾𝚃 卍  instagram.com/hetlarr_ofiicial تابعني على الانستغرام ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '卍 HETLAR 𝙱𝙾𝚃 卍 https://www.instagram.com/hetlarr_ofiicial' : process.env.CAPTION,
    ...
    STIC_WM: process.env.STIC_WM === undefined ? '卍 HETLAR 𝙱𝙾𝚃 卍' : process.env.STIC_WM,
};